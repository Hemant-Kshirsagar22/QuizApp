...
public interface DatabaseStrings {
    ...
    // user table queries
    String USER_TABLE_CREATION_QUERY = "CREATE TABLE " +USER_TABLE_NAME +" ("+ USER_COLUMN_ID +" INTEGER PRIMARY KEY AUTOINCREMENT, " + USER_COLUMN_FIRST_NAME + " TEXT, " + USER_COLUMN_LAST_NAME + " TEXT, " + USER_COLUMN_EMAIL + " TEXT, " + USER_COLUMN_PASSWORD + " TEXT);";
